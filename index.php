...
// Call the afficher() method on the Project object
$Projects = $project->afficher();
					...
					<div class="welcome-hero-form">
						...
						<div class="single-welcome-hero-form">
							...
							<form action="index.html">
								<input type="text" placeholder="Ex: Tunis, Sfax, Gabès" id="search-input" list="options"/>
							</form>
							<datalist id="options">
								<option value="Ariana">
								<option value="Beja">
							...
							<script>
								...
								searchInput.addEventListener('input', function() {
									...
									// Hide or show options based on the input
								...
								<div class="single-explore-txt bg-theme-1">
									...
									<p class="explore-rating-price">
										...
										<span class="explore-price-box">
											form
											<span class="explore-price"><?= $Project->emplacement ?></span>
										</span>
										<a href="#"><?= $Project->type ?></a>
									</p>
										...
										<div class="row">
											<div class="col-sm-2">
												<div class="explore-person-img">
													<a href="#">
														<img src="assets/img/<?= $Project->img_princ ?>" alt="explore person">
													</a>
												</div>
											</div>
											<div class="col-sm-10">
